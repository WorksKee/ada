...
const translations = {
  en: {
    ...
    "Exhibitor.subtitle1":"Custom-built exhibition booths",
    "Exhibitor.subtitle2":"B2B matchmaking",
    "Exhibitor.subtitle3":"Media exposure",
    "Exhibitor.subtitle4":"VIP networking",
    "Exhibitor.subtitle5":"Strategic planning",
    "Exhibitor.subtitle6":"Subsidized options",
    "Exhibitor.text1":"Premium design tailored to your brand and products",
    "Exhibitor.text2":"Access to buyers, investors, and stakeholders",
    "Exhibitor.text3":"International coverage for your brand",
    "Exhibitor.text4":"Exclusive opportunities to connect",
    "Exhibitor.text5":"One-on-one session with Keeada",
    "Exhibitor.text6":"Special rates via Scandinavian channel",
  ...
  sv: {
   // Navigation
    ...
    "Exhibitor.subtitle1": "Skräddarsydda utställningsbås",
    "Exhibitor.subtitle2": "B2B-matchmaking",
    "Exhibitor.subtitle3": "Medieexponering",
    "Exhibitor.subtitle4": "VIP-nätverkande",
    "Exhibitor.subtitle5": "Strategisk planering",
    "Exhibitor.subtitle6": "Subventionerade alternativ",
    "Exhibitor.text1": "Premiumdesign anpassad till ditt varumärke och produkter",
    "Exhibitor.text2": "Tillgång till köpare, investerare och intressenter",
    "Exhibitor.text3": "Internationell täckning för ditt varumärke",
    "Exhibitor.text4": "Exklusiva möjligheter att nätverka",
    "Exhibitor.text5": "Ensessionsmöte med Keeada",
    "Exhibitor.text6": "Särskilda priser via den skandinaviska kanalen",
